      ...
      <div className="container mx-auto px-4 py-8 sm:px-6 lg:px-8">
        <div className="max-w-9xl mx-auto">
          ...
          <div className="text-center mb-12">
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-blue-900 mb-4">
              Privacy Policy
            </h1>
              ...
              <div>
                ...
                <div className="grid gap-4">
                  {[
                    ...
                    { term: "Company", definition: "(referred to as either 'the Company', 'We', 'Us' or 'Our' in this Agreement) refers to PIONEER GIRLS SCHOOL, P.O. Box 33421, 00600 Thika Rd, Nairobi" },
                    ...
                    { term: "Website", definition: "refers to PIONEER GIRLS SCHOOL, accessible from https://pioneergirlsschool.co.ke" },
