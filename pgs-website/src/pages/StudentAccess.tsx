...
const AccessButton: React.FC<{ text: string, to: string }> = ({ text, to }) => (
  <Link
    to={to}
    role="button"
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8">
              <AccessButton text="CLUBS & SPORTS REGISTRATION" to="/student-access" />
              <AccessButton text="ONLINE CLASS ACCESS" to="https://teams.microsoft.com/l/team/19%3AdjcOjPLAUrxcRHA4kcbg9XYjbeYfQ6N1kKQWQ47pgeg1%40thread.tacv2/conversations?groupId=9bef5088-e1fc-4f1d-89db-c64c22834818&amp;tenantId=bd7222c7-0cef-4bc5-9e9e-d5f8b5bbb1e2" />
            </div>
          </div>
        </div>
      </section>
