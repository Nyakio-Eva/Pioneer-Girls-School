...
const AccessButton: React.FC<{ text: string, to: string, icon: React.ElementType }> = ({ text, to, icon: Icon }) => (
  <Link
    to={to}
    role="button"
    className="flex items-center justify-center bg-amber-500 text-slate-800 hover:bg-slate-300 font-bold uppercase text-sm px-6 py-4 rounded-md shadow-md hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-amber-400 focus:ring-opacity-75 transition-all duration-300 ease-in-out text-center"
  >
