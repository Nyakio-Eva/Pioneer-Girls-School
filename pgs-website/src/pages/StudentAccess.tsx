        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 mb-12">
              <AccessButton text="MOODLE E-LEARNING" />
              <AccessButton text="STUDENT MAIL" />
              <AccessButton text="ONLINE LIBRARY" />
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8">
              <AccessButton text="CLUBS & SPORTS REGISTRATION" />
              <AccessButton text="ONLINE CLASS ACCESS" />
            </div>
          </div>
        </div>
      </section>
