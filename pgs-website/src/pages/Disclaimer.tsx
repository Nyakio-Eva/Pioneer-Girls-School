  ...
  const disclaimerItems = [
    {
      ...
      content: "PIONEER GIRLS SCHOOL makes every effort to ensure the accuracy and reliability of the information provided on this website. However, we cannot guarantee that all information is error-free, complete, or current. PIONEER GIRLS SCHOOL shall not be liable for any direct, indirect, incidental, special, or consequential damages arising out of the use or inability to use the information provided on this website."
    },
    {
      icon: AlertTriangle,
    ...
    },
    {
      ...
      content: "The information provided on this website is not intended to be a substitute for professional advice. Visitors to this website should not act upon the information provided without seeking professional guidance. PIONEER GIRLS SCHOOL does not provide any professional or legal advice through this website."
    },
    {
      icon: Globe,
      title: "Third-party Content",
      content: "This website may contain links or references to third-party websites, products, or services. These links are provided for convenience only and do not imply endorsement or approval by PIONEER GIRLS SCHOOL. We have no control over the content or actions of these third-party websites and shall not be responsible for any damages or losses arising from their use."
    },
    {
      icon: Copyright,
      title: "Copyright and Intellectual Property",
      content: "All content and materials on this website, including but not limited to text, graphics, logos, images, audio clips, and video clips, are the property of PIONEER GIRLS SCHOOL or its content suppliers and are protected by copyright and other intellectual property laws. Unauthorized use, reproduction, or distribution of any materials from this website is strictly prohibited."
    },
    {
      icon: Settings,
      title: "Modification of Terms",
      content: "PIONEER GIRLS SCHOOL reserves the right to modify, update, or amend the terms of this disclaimer at any time without prior notice. By continuing to use this website, you agree to be bound by the most current version of the disclaimer."
    }
  ];
      ...
      <div className="md:max-w-7xl max-w-6xl mx-auto">
        ...
        <div className="text-center mt-16">
          <div className="inline-flex items-center space-x-2 text-gray-500">
            ...
            <span className="text-sm font-medium">Last updated: {new Date().getFullYear()}</span>
