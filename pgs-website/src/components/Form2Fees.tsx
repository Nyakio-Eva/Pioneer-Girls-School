...
export default function Form2Fees() {
  return (
    <section className="bg-white text-gray-800">
      {/* Header Section */}
      <div className="w-full bg-cover bg-center py-10 px-4 md:px-10" style={{ backgroundImage: "url('/undefined')" }}>
        <div className="max-w-5xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">FORM 2 FEES</h2>
      ...
      <div className="max-w-5xl mx-auto px-4 py-10 space-y-6">
        ...
        {["TERM 1", "TERM 2", "TERM 3"].map((term, idx) => (
          <p key={idx} className="text-lg font-semibold text-yellow-800">
            FORM 2 - {term} - <span className="text-yellow-600">KES 115,500</span>
          </p>
        ))}
        <p className="text-lg font-bold text-yellow-800">
          ANNUAL FEES - <span className="text-yellow-600">KES 346,500</span>
        </p>
      </div>
      ...
      <div className="py-10 px-4">
        <div className="max-w-5xl mx-auto space-y-4 text-base md:text-lg font-medium text-gray-700">
          ...
          <p>Money paid is not refundable or transferable.</p>
          <p>All fees should be paid to Pioneer Girls School accounts only.</p>
          <p>Accepted modes of payment are:</p>
          ...
          <p className="mt-4">
            ...
            <a href="mailto:finance.enquiries@pioneergirlsschools.co.ke" className="text-blue-600 underline">
