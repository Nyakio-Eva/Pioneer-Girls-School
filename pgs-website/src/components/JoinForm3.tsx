...
const eligibilityRequirements: Requirement[] = [
  { text: 'Attain a minimum score of 350 or higher on the Kenya Certificate of Primary Education (KCPE) exam. Current Academic records for Form 1 and Form 2 are also required.' },
  ...
  return (
    <div className="bg-[#d3e0f3ff] font-sans">
      ...
      <div className="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8 -mt-40">
        <div className="bg-[#f2f2f2] shadow-2xl rounded-xl p-6 md:p-10">
          ...
          <section className="mb-12">
            ...
            <hr className="w-24 h-1 bg-blue-500 mb-6" />
          ...
          <section className="mb-12 text-center">
            ...
            <hr className="w-20 h-1 bg-blue-500 mx-auto mb-4" />
          ...
          <section className="mb-12">
            ...
            <hr className="w-20 h-1 bg-blue-500 mb-6" />
          ...
          <section className="mt-16 text-center">
            <button
              ...
              className="w-full md:w-auto bg-slate-700 text-white font-bold py-4 px-12 rounded-lg text-2xl hover:bg-yellow-700 transition-colors duration-300 shadow-lg"
            >
              Join Form Four
            </button>
          </section>
