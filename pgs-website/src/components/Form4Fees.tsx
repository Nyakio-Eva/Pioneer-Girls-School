...
export default function Form4Fees() {
  return (
    <section className="bg-slate-200 text-gray-800">
      ...
      >
        <div className="max-w-5xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">FORM 4 FEES</h2>
      ...
      <div className="max-w-5xl mx-auto px-4 py-10 space-y-6">
        ...
        {["TERM 1", "TERM 2", "TERM 3"].map((term, idx) => (
          <p key={idx} className="text-lg font-semibold text-yellow-800">
            FORM 4 - {term} - <span className="text-yellow-600">KES 136,500</span>
          </p>
        ))}
        <p className="text-lg font-bold text-yellow-800">
          ANNUAL FEES - <span className="text-yellow-600">KES 409,500</span>
        </p>
      </div>
      ...
      <div className="bg-gray-100 py-10 px-4">
        <div className="max-w-5xl mx-auto space-y-4">
          <h3 className="text-xl font-bold text-yellow-700">New Student Charges</h3>
          <ul className="list-disc pl-5 space-y-2 text-base md:text-lg font-medium text-gray-700">
            <li>There is <strong>no admission</strong> at Form Four.</li>
            <li>Non-refundable Commitment Fee - <strong>NIL</strong></li>
            <li>Extra charge for uniform, bedding, and textbooks - <strong>NIL</strong></li>
      ...
      <div className="py-10 px-4 flex justify-center">
        <button
          onClick={() => (window.location.href = 'https://enquireto.pioneergroupofschools.co.ke/')}
          className="bg-yellow-500 hover:bg-yellow-600 text-white text-lg font-bold py-3 px-6 rounded-xl shadow-md transition"
        >
          Book a Visit
        </button>
      </div>
