...
const eligibilityRequirements: Requirement[] = [
  { text: 'Attain a minimum score of 350 or higher on the Kenya Certificate of Primary Education (KCPE) exam. Current Academic records for Form 1, Form 2, and Form 3 are also required.' },
        ...
        <div className="bg-white shadow-2xl rounded-xl p-6 md:p-10">
          ...
          <section className="mt-16 text-center">
            <button
              ...
              className="w-full md:w-auto bg-blue-900 text-white font-bold py-4 px-12 rounded-lg text-2xl hover:bg-yellow-700 transition-colors duration-300 shadow-lg"
            >
              Our Fees
            </button>
          </section>
